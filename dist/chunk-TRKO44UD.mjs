...
import { islandBarVariants, springs, activeBubbleVariants } from './chunk-KQD7AAHC.mjs';
import { useState } from 'react';
import { motion, AnimatePresence } from 'framer-motion';
import { cva } from 'class-variance-authority';
import { jsxs, jsx } from 'react/jsx-runtime';

var islandBarVariantsCVA = cva(
  [
  ...
  return /* @__PURE__ */ jsxs(
    motion.button,
    {
      ...
      children: [
        ...
        item.badge !== void 0 && item.badge > 0 && /* @__PURE__ */ jsx("span", { className: "absolute -right-0.5 -top-0.5 flex h-4 min-w-4 items-center justify-center rounded-full bg-red-500 px-1 text-[10px] font-bold text-white", children: item.badge > 99 ? "99+" : item.badge }),
...
function FloatingIslandBar({
  ...
  return /* @__PURE__ */ jsxs(
    motion.nav,
    {
      ...
      children: [
        /* @__PURE__ */ jsx("div", { className: "absolute inset-0 rounded-full opacity-[0.03] [background-image:url('data:image/svg+xml;base64,')] pointer-events-none" }),
        /* @__PURE__ */ jsx("div", { className: "absolute -bottom-3 left-1/2 h-4 w-3/5 -translate-x-1/2 rounded-full bg-purple-500/20 blur-lg pointer-events-none" }),
        /* @__PURE__ */ jsxs(
          "div",
          {
            className: cn(
            ...
            ...props,
            children: [
              leftItems.map((item) => /* @__PURE__ */ jsx(
                NavIcon,
                {
                  item,
              ...
              centerAction && /* @__PURE__ */ jsx(
                motion.button,
                {
                  ...
                  children: /* @__PURE__ */ jsx("span", { className: "text-white text-xl", children: centerAction.icon })
                }
              ),
              rightItems.map((item) => /* @__PURE__ */ jsx(
                NavIcon,
                {
                  item,
                  isActive: activeId === item.id,
...
export { FloatingIslandBar, floating_island_bar_default };
//# sourceMappingURL=chunk-TRKO44UD.mjs.map
//# sourceMappingURL=chunk-TRKO44UD.mjs.map