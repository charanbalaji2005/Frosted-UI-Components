...
import { springs, orbPulseVariants, fabActionVariants } from './chunk-KQD7AAHC.mjs';
import { useState, useRef, useEffect } from 'react';
import { motion, AnimatePresence } from 'framer-motion';
import { X, Search, ArrowUp, Plus, Mic, Paperclip, Zap, Globe } from 'lucide-react';
            ...
            children: [
              ...
              /* @__PURE__ */ jsx(
                motion.button,
                {
                  ...
                  children: /* @__PURE__ */ jsx(AnimatePresence, { mode: "wait", children: expanded ? /* @__PURE__ */ jsx(motion.span, { initial: { scale: 0, rotate: -90 }, animate: { scale: 1, rotate: 0 }, exit: { scale: 0, rotate: 90 }, transition: springs.snap, whileHover: { scale: 1.15, rotate: 10 }, children: /* @__PURE__ */ jsx(X, { size: 20 }) }, "x") : /* @__PURE__ */ jsx(motion.span, { initial: { scale: 0 }, animate: { scale: 1 }, exit: { scale: 0 }, transition: springs.snap, whileHover: { scale: 1.15, rotate: 10 }, children: /* @__PURE__ */ jsx(Search, { size: 20 }) }, "s") })
                }
              ),
                  ...
                  children: [
                    ...
                    value && /* @__PURE__ */ jsx(
                      motion.button,
                      {
                        ...
                        children: /* @__PURE__ */ jsx(ArrowUp, { size: 13 })
                      }
                    )
                  ]
                }
...
function FloatingActionButton({
  ...
  return /* @__PURE__ */ jsxs("div", { className: cn(fixed && "fixed", positionClass(position), "z-50 flex flex-col items-center gap-3", className), children: [
    /* @__PURE__ */ jsx(AnimatePresence, { children: open && actions.map((action, i) => /* @__PURE__ */ jsxs(
      motion.div,
      {
    ...
    /* @__PURE__ */ jsxs(
      motion.button,
      {
        ...
        children: [
          /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-white/[0.15] to-transparent pointer-events-none" }),
          /* @__PURE__ */ jsx(
            motion.span,
            {
              ...
              transition: { type: "spring", stiffness: 400, damping: 10 },
              children: icon ?? /* @__PURE__ */ jsx(Plus, { size: 24 })
            }
          )
        ]
      }
    ),
    !open && glow && /* @__PURE__ */ jsx(
      motion.div,
      {
...
var DEFAULT_CHIPS = [
  { id: "voice", label: "Voice", icon: /* @__PURE__ */ jsx(Mic, { size: 13 }) },
  { id: "attach", label: "Attach", icon: /* @__PURE__ */ jsx(Paperclip, { size: 13 }) },
  { id: "quick", label: "Quick", icon: /* @__PURE__ */ jsx(Zap, { size: 13 }) },
  { id: "web", label: "Web", icon: /* @__PURE__ */ jsx(Globe, { size: 13 }) }
];
  ...
  return /* @__PURE__ */ jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 px-4 py-3.5", children: [
                /* @__PURE__ */ jsx("div", { className: "flex h-8 w-8 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-purple-500/70 to-blue-500/70 shadow-[0_0_20px_rgba(120,80,255,0.3)]", children: /* @__PURE__ */ jsx(
                  motion.span,
                  {
              ...
              /* @__PURE__ */ jsx("div", { className: "flex items-center gap-2 overflow-x-auto px-4 pb-3 scrollbar-none", children: chipList.map((chip) => /* @__PURE__ */ jsxs(
                motion.button,
                {
        ...
        glow && /* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute -bottom-3 left-1/2 h-6 w-3/5 -translate-x-1/2 rounded-full bg-purple-500/15 blur-xl" })
      ]
    }
  );
}
...
export { FloatingActionButton, FloatingCommandBar, FloatingSearchOrb, floating_elements_default };
//# sourceMappingURL=chunk-IRSNCBS5.mjs.map
//# sourceMappingURL=chunk-IRSNCBS5.mjs.map