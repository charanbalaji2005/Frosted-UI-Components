...
var islandBarVariantsCVA = classVarianceAuthority.cva(
  [
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsx(framerMotion.AnimatePresence, { children: isActive && /* @__PURE__ */ jsxRuntime.jsx(
          framerMotion.motion.span,
          {
            ...
            variants: chunkVUFUBZXH_js.activeBubbleVariants,
            initial: "inactive",
            animate: "active",
            exit: "inactive",
        ...
        item.badge !== void 0 && item.badge > 0 && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "absolute -right-0.5 -top-0.5 flex h-4 min-w-4 items-center justify-center rounded-full bg-red-500 px-1 text-[10px] font-bold text-white", children: item.badge > 99 ? "99+" : item.badge }),
...
function FloatingIslandBar({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    framerMotion.motion.nav,
    {
      ...
      variants: chunkVUFUBZXH_js.islandBarVariants,
      initial: "hidden",
      animate: "visible",
      "aria-label": "Main navigation",
      children: [
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: "absolute inset-0 rounded-full opacity-[0.03] [background-image:url('data:image/svg+xml;base64,')] pointer-events-none" }),
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: "absolute -bottom-3 left-1/2 h-4 w-3/5 -translate-x-1/2 rounded-full bg-purple-500/20 blur-lg pointer-events-none" }),
        /* @__PURE__ */ jsxRuntime.jsxs(
          "div",
          {
            className: chunkCBUS6MRO_js.cn(
              islandBarVariantsCVA({ variant, glow }),
              className
            ),
            ...props,
            children: [
              leftItems.map((item) => /* @__PURE__ */ jsxRuntime.jsx(
                NavIcon,
                {
                  item,
              ...
              centerAction && /* @__PURE__ */ jsxRuntime.jsx(
                framerMotion.motion.button,
                {
                  className: chunkCBUS6MRO_js.cn(
                  ...
                  children: /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-white text-xl", children: centerAction.icon })
                }
              ),
              rightItems.map((item) => /* @__PURE__ */ jsxRuntime.jsx(
                NavIcon,
                {
                  item,
                  isActive: activeId === item.id,
...
var floating_island_bar_default = FloatingIslandBar;

exports.FloatingIslandBar = FloatingIslandBar;
exports.floating_island_bar_default = floating_island_bar_default;
//# sourceMappingURL=chunk-VIMNN6CD.js.map
//# sourceMappingURL=chunk-VIMNN6CD.js.map