...
function AppLauncher({
  ...
  return /* @__PURE__ */ jsx("div", { className: cn("relative w-full", className), children: /* @__PURE__ */ jsxs(
    "div",
    {
      className: cn(
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(
          motion.div,
          {
            ...
            children: visible.map((app, i) => /* @__PURE__ */ jsx(AppIcon, { app, index: i }, app.id))
          },
          page
        ),
        pages && totalPages > 1 && /* @__PURE__ */ jsx("div", { className: "mt-4 flex justify-center gap-1.5", children: Array.from({ length: totalPages }).map((_, i) => /* @__PURE__ */ jsx(
          "button",
          {
            className: cn(
      ...
      children: [
        /* @__PURE__ */ jsxs(
          motion.button,
          {
            ...
            children: [
              /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-white/[0.18] to-transparent pointer-events-none" }),
              /* @__PURE__ */ jsx(
                motion.span,
                {
        ...
        /* @__PURE__ */ jsx("span", { className: "max-w-[56px] truncate text-center text-[11px] font-medium text-white/65", children: app.label })
      ]
    }
  );
}
...
export { AppLauncher, app_launcher_default };
//# sourceMappingURL=chunk-EK52DXSX.mjs.map
//# sourceMappingURL=chunk-EK52DXSX.mjs.map