...
function CrystalBar({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    framerMotion.motion.nav,
    {
      ...
      children: [
        glow && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "absolute -bottom-4 left-1/2 h-8 w-2/3 -translate-x-1/2 rounded-full bg-cyan-400/15 blur-xl pointer-events-none" }),
      ...
      children: /* @__PURE__ */ jsxRuntime.jsxs(
        "div",
        {
          ...
          children: [
            ...
            glow && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "absolute left-[20%] right-[20%] top-0 h-px rounded-full bg-gradient-to-r from-transparent via-blue-300/40 to-transparent pointer-events-none" }),
            items.map((item) => {
              const isActive = activeId === item.id;
              return /* @__PURE__ */ jsxRuntime.jsxs(
                framerMotion.motion.button,
...
function RibbonBar({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    framerMotion.motion.nav,
    {
      ...
      className: chunkCBUS6MRO_js.cn("flex flex-col items-stretch", className),
      children: [
        showRibbonLayers && /* @__PURE__ */ jsxRuntime.jsx("div", { className: chunkCBUS6MRO_js.cn(
        ...
        glow && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "absolute -bottom-4 left-1/2 h-6 w-3/5 -translate-x-1/2 rounded-full bg-amber-500/15 blur-xl pointer-events-none" })
      ]
    }
  );
}

exports.ArcBar = ArcBar;
exports.CrystalBar = CrystalBar;
exports.RibbonBar = RibbonBar;
//# sourceMappingURL=chunk-KXZGKA6A.js.map
//# sourceMappingURL=chunk-KXZGKA6A.js.map