...
import type { FloatingSearchOrbProps, FloatingActionButtonProps, FloatingCommandBarProps } from "../types";
      ...
      >
        ...
        >
          <AnimatePresence mode="wait">
            {expanded ? (
              <motion.span key="x" initial={{ scale: 0, rotate: -90 }} animate={{ scale: 1, rotate: 0 }} exit={{ scale: 0, rotate: 90 }} transition={springs.snap}>
                <X size={20} />
              </motion.span>
            ) : (
              <motion.span key="s" initial={{ scale: 0 }} animate={{ scale: 1 }} exit={{ scale: 0 }} transition={springs.snap}>
                <Search size={20} />
              </motion.span>
            )}
          </AnimatePresence>
